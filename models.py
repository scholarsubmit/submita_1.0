...
class User(UserMixin, db.Model):
    ...
    role = db.Column(db.String(20), default=UserRole.STUDENT)  # student, lecturer, admin
    ...
    created_assignments = db.relationship('AssignmentSubmission', backref='creator', lazy=True)
